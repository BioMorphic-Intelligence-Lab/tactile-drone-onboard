...
def generate_launch_description():
    ...
    start_repeated_contact_based_planner = Node(package = pkg_name,
                                       name = 'repeated_contact_based_reference_finder',
                                       executable = 'repeated_contact_based_reference_finder',
                                       parameters = [config]
    )
    
    ld.add_action(start_base_reference_publisher)
    ld.add_action(start_repeated_contact_based_planner)
